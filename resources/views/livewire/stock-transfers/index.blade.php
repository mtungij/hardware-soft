...
<div>
    <x-page-header title="Stock Transfers" description="Transfer stock between authorized internal locations." :breadcrumbs="['Dashboard' => route('dashboard'), 'Stock Transfers' => null]">
