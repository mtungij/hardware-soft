...
layout('layouts.app');
state(['purchaseRequest'=>null,'quotation'=>null,'quote_lines'=>[],'additional_charges'=>[],'document_type'=>'quotation','quotation_template_key'=>'','valid_until'=>'','notes'=>'','terms'=>'Payment and delivery subject to agreed terms.','stock_location_id'=>'','payment_method'=>'credit']);
...
<label class="text-sm font-bold">Document Type<select wire:model.live="document_type" class="mt-1 w-full rounded-xl border-slate-200 dark:bg-navy-950">
