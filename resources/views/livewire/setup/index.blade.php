    ...
    <div class="mx-auto max-w-6xl">
        <div class="mb-6 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xl font-black text-navy-900 dark:text-white">Hardex Hardware ERP</p>
        ...
        <div class="grid gap-6 lg:grid-cols-[280px_1fr]">
            <aside class="rounded-2xl border border-slate-200 bg-white p-4 shadow-soft dark:border-slate-800 dark:bg-slate-900">
                @foreach ([1 => 'Hardware Business Information', 2 => 'Super Admin Account', 3 => 'Branch Information', 4 => 'Review & Complete'] as $number => $label)
                    <button type="button" wire:click="goTo({{ $number }})" class="mb-2 flex w-full items-center gap-3 rounded-xl px-3 py-3 text-left transition {{ $step === $number ? 'bg-orange-50 text-build-orange dark:bg-orange-500/15' : 'text-slate-500 hover:bg-slate-50 dark:hover:bg-white/5' }}">
            ...
            <section class="rounded-2xl border border-slate-200 bg-white p-5 shadow-soft dark:border-slate-800 dark:bg-slate-900 sm:p-6">
                @if ($step === 1)
                    <div>
