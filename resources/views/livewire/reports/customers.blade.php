...
<div>
    <x-page-header title="Customer Balance Report" description="Customer credit limits, outstanding balances, and payment exposure." :breadcrumbs="['Dashboard' => route('dashboard'), 'Reports' => null, 'Customers' => null]"><x-export-actions export="reports.customers" :params="compact('search')" /></x-page-header>
