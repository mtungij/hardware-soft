...
<div class="mx-auto max-w-2xl">
    <div class="rounded-3xl border border-amber-200 bg-amber-50 p-8 text-center dark:border-amber-500/30 dark:bg-amber-500/10">
        ...
        <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <a href="https://wa.me/255629364847" target="_blank" class="rounded-xl bg-emerald-600 px-4 py-3 text-sm font-black text-white">{{ __('messages.support.chat_whatsapp') }}</a>
