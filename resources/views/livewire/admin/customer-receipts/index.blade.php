...
$receipts = computed(function () {
    return CustomerReceipt::with(['customer', 'sale', 'account'])
...
<div>
    <x-page-header title="Customer Receipts" description="Review uploaded customer debt payment receipts." :breadcrumbs="['Dashboard' => route('dashboard'), 'Customer Receipts' => null]" />
    <x-card>
        ...
        <x-table :headers="['Date', 'Customer', 'Sale', 'Reference', 'Amount', 'Status', 'Actions']">
            ...
            @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-sm text-slate-500">No receipts found.</td></tr>
            @endforelse
        </x-table>
