...
<div {{ $attributes->merge(['class' => 'mb-4 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between']) }}>
    ...
    <div class="flex flex-wrap gap-2">
        <button type="button" class="rounded-lg border border-slate-200 px-3 py-2 text-sm font-bold dark:border-slate-700">Filters</button>
        <button type="button" class="rounded-lg border border-slate-200 px-3 py-2 text-sm font-bold dark:border-slate-700">Export</button>
        {{ $slot }}
    </div>
</div>
