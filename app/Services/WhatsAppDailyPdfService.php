...
{
    public function generate(Company $company, WhatsAppRecipient $recipient, CarbonInterface $date, array $data): string
    {
        ...
        $pdf->WriteHTML(view('pdf.whatsapp-daily-summary', ['data' => $data])->render());
