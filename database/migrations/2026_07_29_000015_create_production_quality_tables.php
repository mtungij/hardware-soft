...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('production_quality_plan_checks', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('company_id')->constrained()->cascadeOnDelete();
            $table->foreignId('production_quality_plan_id')->constrained('production_quality_plans')->cascadeOnDelete();
            $table->string('name');
        ...
        Schema::create('production_quality_inspections', function (Blueprint $table): void {
            ...
            $table->foreignId('production_quality_plan_id')->constrained('production_quality_plans')->restrictOnDelete();
            $table->foreignId('production_order_id')->nullable()->constrained('production_orders')->restrictOnDelete();
            $table->foreignId('production_curing_batch_id')->nullable()->constrained('production_curing_batches')->restrictOnDelete();
            $table->foreignId('product_id')->constrained('products')->restrictOnDelete();
            ...
            $table->foreignId('supersedes_inspection_id')->nullable()->constrained('production_quality_inspections')->restrictOnDelete();
            $table->text('notes')->nullable();
            $table->timestamps();
        ...
        Schema::create('production_quality_inspection_results', function (Blueprint $table): void {
            ...
            $table->foreignId('production_quality_plan_check_id')->nullable()->constrained('production_quality_plan_checks')->nullOnDelete();
        ...
        Schema::create('production_quality_holds', function (Blueprint $table): void {
            ...
            $table->foreignId('production_order_id')->nullable()->constrained('production_orders')->restrictOnDelete();
            $table->foreignId('production_curing_batch_id')->nullable()->constrained('production_curing_batches')->restrictOnDelete();
            $table->foreignId('production_quality_inspection_id')->nullable()->constrained('production_quality_inspections')->restrictOnDelete();
            $table->foreignId('product_id')->constrained('products')->restrictOnDelete();
