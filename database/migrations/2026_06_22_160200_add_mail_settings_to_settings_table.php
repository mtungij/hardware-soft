...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('settings', function (Blueprint $table) {
            $table->string('mail_host')->nullable()->after('theme_color');
            ...
            $table->string('mail_from_email')->nullable()->after('mail_encryption');
    ...
    {
        Schema::table('settings', function (Blueprint $table) {
            $table->dropColumn(['mail_host', 'mail_port', 'mail_username', 'mail_password', 'mail_encryption', 'mail_from_email', 'mail_from_name']);
        });
    }
};
